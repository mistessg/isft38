     ...
     @forelse($carreras as $carrera)
       ...
       <table class="table table-dark">  
        <tr>
          ...
          <td>
          <a class="btn btn-success" href="{{ route('carrera.create') }}">
       ...
       <tr>
        ...
        <td>
         ...
         <td>
          {{ Form::model($carrera, [ 'method' => 'delete' , 'route' => ['carrera.destroy', $carrera->id] ]) }}
            @csrf  
        <a href="{{ route('carrera.show', ['carrera' => $carrera->id ]) }}" class="btn btn-info"><img src="{{ asset('svg/show.svg') }}"  width="20" height="20" alt="Mostrar" title="Mostrar"></a> 
        ...
        <a href="{{ route('carrera.edit', ['carrera' => $carrera->id ]) }}" class="btn btn-primary"><img src="{{ asset('svg/edit.svg') }}" width="20" height="20" alt="Editar" title="Editar"></a>       
        <a href="" class="btn btn-info">Horarios 1°</a>     
        <a href="" class="btn btn-info">Horarios 2°</a> 
        <a href="" class="btn btn-info">Horarios 3°</a>          
            {!!Form::close()!!}  
         </td>
      </tr>
       @if($loop->last)
